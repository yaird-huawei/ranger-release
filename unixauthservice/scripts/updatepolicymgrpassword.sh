...
then
        ...
        $JAVA_HOME/bin/java -cp "./lib/*" com.hortonworks.credentialapi.buildks create "$SYNC_POLICY_MGR_ALIAS" -value "$SYNC_POLICY_MGR_PASSWORD" -provider jceks://file$SYNC_LDAP_BIND_KEYSTOREPATH
fi
