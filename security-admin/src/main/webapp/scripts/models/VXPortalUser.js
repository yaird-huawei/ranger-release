		...
		schema : function(){
			...
			return _.extend(attrs,{
				firstName : {
					...
					validators  : ['required',{type:'regexp',regexp:/^[a-zA-Z][a-zA-Z0-9\s_.-]*[a-zA-Z0-9\s_.-]+$/,message :'First name should start with alphabets & can have underscore, hyphen, space, dot.'}],
				...
				lastName : {
					...
					validators  : [{type:'regexp',regexp:/^[a-zA-Z][a-zA-Z0-9\s_.-]*[a-zA-Z0-9\s_.-]+$/,message :'Last name should start with alphabets & can have underscore, hyphen, space, dot.'}],
