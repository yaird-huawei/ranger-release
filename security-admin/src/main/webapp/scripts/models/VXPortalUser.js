		...
		schema : function(){
			...
			return _.extend(attrs,{
				...
				lastName : {
					...
					validators  : ['required',{type:'regexp',regexp:/^[a-zA-Z0-9][a-zA-Z0-9\s_+.-]+$/,message :'Last name should start with alpha/numeric letters and can have number,underscore, hyphen, space, dot and plus.'}],
