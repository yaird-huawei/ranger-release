#!/bin/bash
cp /c/Users/y00495068/dev/code/yaird/ranger-release/plugin-kafka/target/ranger-kafka-plugin-1.0.0.3.0.0.0-SNAPSHOT.jar /c/Users/y00495068/dev/code/yaird/ranger-release/xcustom-settings/ranger-kafka-plugin-1.1.0.3.0.1.0-187.jar
